...
class PreEligibilityServiceBase(abc.ABC):
    @abc.abstractmethod
    async def CheckPreEligibility(
        self,
        stream: "grpclib.server.Stream[maven_schemas.eligibility.pre_eligibility_pb2.PreEligibilityRequest, maven_schemas.eligibility.pre_eligibility_pb2.PreEligibilityResponse]",
    ) -> None:
        pass
