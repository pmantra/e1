...
from sqlalchemy.dialects.postgresql import BOOLEAN, DATE, DATERANGE, JSONB, TEXT
from sqlalchemy.ext.hybrid import hybrid_property


class MemberVersioned(Base):
    __tablename__ = "member_versioned"
    ...
    pre_verified = Column("pre_verified", BOOLEAN)
    hash_value = Column("hash_value", TEXT)
    hash_version = Column("hash_version", Integer)
